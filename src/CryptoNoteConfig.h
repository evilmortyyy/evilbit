...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x344519f62; // addresses start with "eviLMo"
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(666666666666666666);
...
const uint64_t MINIMUM_FEE_V2                                = UINT64_C(10000000000);
...
const uint32_t UPGRADE_HEIGHT_V2                             = 2;  // Block v2, pre-LWMA
const uint32_t UPGRADE_HEIGHT_V3                             = 100; // Block v3, LWMA1
const uint32_t UPGRADE_HEIGHT_V3_1                           = 120; // Min fee v2, cap max mixin
const uint32_t UPGRADE_HEIGHT_V4                             = 220; // Block v4, LWMA2, adaptive min fee, min mixin, disable slave merge mining
const uint32_t UPGRADE_HEIGHT_V4_1                           = 320; // LWMA3
const uint32_t UPGRADE_HEIGHT_V4_2                           = 420; // Fee per-byte for extra, ban unmixable denominations
const uint32_t UPGRADE_HEIGHT_V5                             = 88888888888888; // Block v5, back to LWMA1+
...
const char     CRYPTONOTE_NAME[]                             = "evilmorty";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001908dcdf3814a029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101912ef74d2d2d4a316c7307108b3fa976cff25929b4b9403d0524094afcc63d42";
...
const int      P2P_DEFAULT_PORT                              =  6663;
const int      RPC_DEFAULT_PORT                              =  6664;
const int      RPC_DEFAULT_SSL_PORT                          =  6665;
const int      WALLET_RPC_DEFAULT_PORT                       =  66500;
const int      WALLET_RPC_DEFAULT_SSL_PORT                   =  66100;
const int      GATE_RPC_DEFAULT_PORT                         =  66000;
const int      GATE_RPC_DEFAULT_SSL_PORT                     =  66100;
